            ...
            try {
                ...
                for (Mode m : group.getModes()) {
                    BenchmarkListEntry br = new BenchmarkListEntry(
                            ...
                            group.getMinWarmupForks(),
                            group.getReconfigureMode(),
                            group.getReconfigureCovThreshold(),
                            group.getReconfigureCiThreshold(),
                            group.getReconfigureKldThreshold(),
                            group.getJvm(),
                            group.getJvmArgs(),
